  ...
  return (
    <div>
        ...
        <div className="flex flex-col text-center p-36 text-black  justify-center items-center gap-10">
            <h1 className="md:text-5xl text-purple-500 font-bold italic ">BIRTHDAY</h1>
            ...
            <button className='md:text-2xl w-32  border-2 p-3 rounded-xl font-bold text-purple-500 '>Find Birthday</button>
